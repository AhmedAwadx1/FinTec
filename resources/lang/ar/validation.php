...
return [
  ...
  'custom'               => [
    'source_account_id' => [
      'different' => 'يجب أن تكون الحسابات المصدر والوجهة مختلفة.',
    ],
    'destination_account_id' => [
      'different' => 'يجب أن تكون الحسابات المصدر والوجهة مختلفة.',
    ],
    'amount' => [
      'min' => 'يجب أن يكون مبلغ التحويل على الأقل 1 سنت.',
      'not_in' => 'لا يمكن أن يكون مبلغ التحويل صفراً.',
    ],
  ],
  ...
  'attributes'           => [
    ...
    'source_account_id'             => 'الحساب المصدر',
    'destination_account_id'        => 'الحساب الوجهة',
    'amount'                        => 'المبلغ',
    ''                         => '',
    ''                         => '',
    ''                         => '',
