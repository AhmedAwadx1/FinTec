...
return [
  ...
  'failed_to_create_account' => 'فشل انشاء الحساب',
  'user_created_successfully' => 'تم انشاء المستخدم بنجاح',
  'source_account_not_active' => 'الحساب المصدر غير مفعل',
  'destination_account_not_active' => 'الحساب الوجهة مفعل',
  'insufficient_balance_in_source_account' => 'الحساب المصدر ليس لديه رصيد كافي',
  'failed_to_transfer_money' => 'فشل ارسال الحواله',
  'failed_to_create_user' => 'فشل انشاء المستخدم',
