      ...
      value: function removeOldImages(currentImage) {
        ...
        Array.from(this.currentImageContainer.children).forEach(function (image) {
          ...
          if (image.dataset.index !== currentImage.dataset.index && !image.dataset.deleting) {
            // Wait 200ms, as the new image can take some time to show on certain browsers (even though it was downloaded before showing). This will prevent flicker, and show some generosity towards slower students
